<div class="navbar-header">
	...
	<div id="navbar-header-left">
		...
		<div id="navbar-header-left-search" class="hidden-sm hidden-md hidden-lg" component="navbar/title">
...
<div class="navbar-collapse collapse navbar-ex1-collapse" id="nav-dropdown">
	...
	<ul id="logged-in-menu" class="nav navbar-nav navbar-right pull-right">
		...
		<li id="user_label" class="dropdown">
			<a class="dropdown-toggle" data-toggle="dropdown" href="#" id="user_dropdown" title="[[global:header.profile]]">
				{buildAvatar(user, "sm", true)}&nbsp;&nbsp;<span class="username" component="header/username">{user.username}</span>&nbsp;<i class="fa fa-caret-down"></i>
			</a>
	...
	<div class="header-topic-title hidden-xs">
		<!-- IF config.searchEnabled -->
		<form id="search-form" class="navbar-form navbar-right" role="search" method="GET" action="/search">
			<div id="search-fields">
				<div class="form-group">
					<input autocomplete="off" type="text" class="form-control" placeholder="[[global:search]]" name="term" value="">
					<a href="#"><i class="fa fa-gears fa-fw advanced-search-link"></i></a>
